...
public class DragListView extends ListView {
    ...
    private DetermineDragable mDetermineDragable;
    ...
    private ViewGroup mDragItem;

    public DragListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mTouchSlop = ViewConfiguration.get(context).getScaledTouchSlop();
        Resources res = getResources();
        mItemHeightNormal = res.getDimensionPixelSize(R.dimen.drag_normal_height);
        mItemHeightHalf = mItemHeightNormal / 2;
        mItemHeightExpanded = res.getDimensionPixelSize(R.dimen.drag_expanded_height);
    }
        ...
        if (mDragListener != null || mDropListener != null) {
            switch (ev.getAction()) {
                ...
                case MotionEvent.ACTION_DOWN:
                    ...
                    // item
                    if ((mDetermineDragable != null) ? mDetermineDragable.dragable(item, x, y) : (x < 64)) {
    ...
    private void startDragging(Bitmap bm, int x, int y) {
        ...
        int backGroundColor = context.getResources().getColor(R.color.background_default);
        //v.setBackgroundColor(backGroundColor);
        //v.setBackgroundResource(R.drawable.drag_title);
    ...
    public DetermineDragable getDetermineDragable() {
        return mDetermineDragable;
    }

    public void setDetermineDragable(DetermineDragable mDetermineDragable) {
        this.mDetermineDragable = mDetermineDragable;
    }
    ...
    public interface DetermineDragable {
        boolean dragable(ViewGroup view, int x, int y);
    }
}
