...
import com.limemobile.app.blog.activity.sns.ShakeListener.OnShakeListener;

public class ShakeActivity extends ThemeActivity implements OnClickListener {
    ...
    public void startVibrato() { // 定义震动
        mVibrator.vibrate(new long[] {
                500, 200, 500, 200
        }, -1); // 第一个｛｝里面是节奏数组， 第二个参数是重复次数，-1为不重复，非-1俄日从pattern的指定下标开始重复
    }
