 ...
 */
public class SpecialTimelineTask extends TAsyncTask<HotBroadcast> {
    public SpecialTimelineTask(ILoadListener loadListener, IResultListener successListener) {
        this(null, loadListener, successListener);
    }

    public SpecialTimelineTask(ViewGroup container, ILoadListener loadListener,
    ...
    public String callAPI(Object... params) {
        ...
        try {
            response = statusesAPI.specialTimeline(TencentWeibo.getInstance(), TencentWeibo.JSON, pageflag,
                    pagetime, reqnum, lastid, type, contenttype);
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
