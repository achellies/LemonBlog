...
import com.limemobile.app.blog.weibo.tencent.entity.friends.FriendOnlyName;
 ...
 */
public class FansListNameTask extends TAsyncTask<FriendOnlyName> {

    public FansListNameTask(ILoadListener loadListener, IResultListener successListener) {
        this(null, loadListener, successListener);
    }

    public FansListNameTask(ViewGroup container, ILoadListener loadListener,
    ...
    public String callAPI(Object... params) {
        ...
        try {
            response = friendsAPI.fanslist_name(TencentWeibo.getInstance(), TencentWeibo.JSON, reqnum,
                    startindex, install);
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
