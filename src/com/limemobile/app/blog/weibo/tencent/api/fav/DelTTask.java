 ...
 * 取消收藏一条微博
 * 
 * @param id String 微博id
 */
public class DelTTask extends TAsyncTask<FavResult> {
    public DelTTask(ILoadListener loadListener, IResultListener successListener) {
        this(null, loadListener, successListener);
    }

    public DelTTask(ViewGroup container, ILoadListener loadListener, IResultListener successListener) {
    ...
    public String callAPI(Object... params) {
        ...
        try {
            response = favoriteAPI.delt(TencentWeibo.getInstance(), TencentWeibo.JSON, id);
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
