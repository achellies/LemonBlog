...
import com.limemobile.app.blog.weibo.tencent.entity.friends.FriendSimple;
 ...
 * 我的听众列表，简单信息（200个）
 * 
 * @param reqnum Integer reqnum 请求个数(1-200)
 ...
 */
public class FansListSTask extends TAsyncTask<FriendSimple> {

    public FansListSTask(ILoadListener loadListener, IResultListener successListener) {
        this(null, loadListener, successListener);
    }

    public FansListSTask(ViewGroup container, ILoadListener loadListener,
    ...
    public String callAPI(Object... params) {
        ...
        try {
            response = friendsAPI.fanslistS(TencentWeibo.getInstance(), TencentWeibo.JSON, reqnum,
                    startindex, install);
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
