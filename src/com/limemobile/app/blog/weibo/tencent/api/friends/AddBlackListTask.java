 ...
 */
public class AddBlackListTask extends TAsyncTask<Empty> {

    public AddBlackListTask(ILoadListener loadListener, IResultListener successListener) {
        this(null, loadListener, successListener);
    }

    public AddBlackListTask(ViewGroup container, ILoadListener loadListener,
    ...
    public String callAPI(Object... params) {
        ...
        try {
            response = friendsAPI
                    .addblacklist(TencentWeibo.getInstance(), TencentWeibo.JSON, name, fopenid);
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
