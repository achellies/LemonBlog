 ...
 */
public class InboxTask extends TAsyncTask<HotBroadcast> {

    public InboxTask(ILoadListener loadListener, IResultListener successListener) {
        this(null, loadListener, successListener);
    }

    public InboxTask(ViewGroup container, ILoadListener loadListener,
    ...
    public String callAPI(Object... params) {
        ...
        try {
            response = privateAPI.recv(TencentWeibo.getInstance(), TencentWeibo.JSON, pageflag, pagetime,
