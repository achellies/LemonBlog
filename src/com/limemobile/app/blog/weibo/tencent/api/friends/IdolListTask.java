 ...
 */
public class IdolListTask extends TAsyncTask<Friend> {

    public IdolListTask(ILoadListener loadListener, IResultListener successListener) {
        this(null, loadListener, successListener);
    }

    public IdolListTask(ViewGroup container, ILoadListener loadListener,
    ...
    public String callAPI(Object... params) {
        ...
        try {
            response = friendsAPI.idollist(TencentWeibo.getInstance(), TencentWeibo.JSON, reqnum,
                    startindex, install);
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
