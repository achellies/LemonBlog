 ...
 */
public class UserSpecialListTask extends TAsyncTask<Friend> {

    public UserSpecialListTask(ILoadListener loadListener, IResultListener successListener) {
        this(null, loadListener, successListener);
    }

    public UserSpecialListTask(ViewGroup container, ILoadListener loadListener,
    ...
    public String callAPI(Object... params) {
        ...
        try {
            response = friendsAPI.userSpeciallist(TencentWeibo.getInstance(), TencentWeibo.JSON, reqnum,
