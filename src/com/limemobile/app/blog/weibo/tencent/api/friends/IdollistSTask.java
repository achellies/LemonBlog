 ...
 */
public class IdollistSTask extends TAsyncTask<FriendSimple> {

    public IdollistSTask(ILoadListener loadListener, IResultListener successListener) {
        this(null, loadListener, successListener);
    }

    public IdollistSTask(ViewGroup container, ILoadListener loadListener,
    ...
    public String callAPI(Object... params) {
        ...
        try {
            response = friendsAPI.idollist_s(TencentWeibo.getInstance(), TencentWeibo.JSON, reqnum,
                    startindex, install);
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
