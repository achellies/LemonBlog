 ...
 * @param reid 是 转播父节点微博id
 * @param syncflag 否
 *            微博同步到空间分享标记（可选，0-同步，1-不同步，默认为0），目前仅支持oauth1.0鉴权方式，此时消息将同步到空间说说
 */
public class ReAddTask extends TAsyncTask<TResult> {
    public ReAddTask(ILoadListener loadListener, IResultListener successListener) {
        this(null, loadListener, successListener);
    }

    public ReAddTask(ViewGroup container, ILoadListener loadListener,
    ...
    public String callAPI(Object... params) {
        ...
        try {
            response = tAPI.reAdd(TencentWeibo.getInstance(), TencentWeibo.JSON, content, clientip,
