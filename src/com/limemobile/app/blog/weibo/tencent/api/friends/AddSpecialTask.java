 ...
 */
public class AddSpecialTask extends TAsyncTask<Empty> {

    public AddSpecialTask(ILoadListener loadListener, IResultListener successListener) {
        this(null, loadListener, successListener);
    }

    public AddSpecialTask(ViewGroup container, ILoadListener loadListener,
    ...
    public String callAPI(Object... params) {
        ...
        try {
            response = friendsAPI.addspecial(TencentWeibo.getInstance(), TencentWeibo.JSON, name, fopenids);
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
