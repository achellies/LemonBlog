 ...
 */
public class VipTransConvTask extends TAsyncTask<HotBroadcast> {

    public VipTransConvTask(ILoadListener loadListener, IResultListener successListener) {
        this(null, loadListener, successListener);
    }

    public VipTransConvTask(ViewGroup container, ILoadListener loadListener,
    ...
    public String callAPI(Object... params) {
        ...
        try {
            response = otherAPI.vip_trans_conv(TencentWeibo.getInstance(), TencentWeibo.JSON, rootid,
