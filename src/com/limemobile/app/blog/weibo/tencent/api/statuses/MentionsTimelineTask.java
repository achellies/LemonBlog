 ...
 */
public class MentionsTimelineTask extends TAsyncTask<HotBroadcast> {
    public MentionsTimelineTask(ILoadListener loadListener, IResultListener successListener) {
        this(null, loadListener, successListener);
    }

    public MentionsTimelineTask(ViewGroup container, ILoadListener loadListener,
    ...
    public String callAPI(Object... params) {
        ...
        try {
            response = statusesAPI.mentionsTimeline(TencentWeibo.getInstance(), TencentWeibo.JSON,
