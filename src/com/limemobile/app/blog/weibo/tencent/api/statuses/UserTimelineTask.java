 ...
 */
public class UserTimelineTask extends TAsyncTask<HotBroadcast> {
    public UserTimelineTask(ILoadListener loadListener, IResultListener successListener) {
        this(null, loadListener, successListener);
    }

    public UserTimelineTask(ViewGroup container, ILoadListener loadListener,
    ...
    public String callAPI(Object... params) {
        ...
        String fopenid = (String) params[5];
        ...
        try {
            response = statusesAPI.userTimeline(TencentWeibo.getInstance(), TencentWeibo.JSON, pageflag,
                    pagetime, reqnum, lastid, name, fopenid, type, contenttype);
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
