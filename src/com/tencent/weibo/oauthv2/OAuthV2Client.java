...
public class OAuthV2Client {
     ...
     * @return
     */
    public static boolean setAuthorization(String authorizeCode, String openid, String openkey,
            OAuthV2 oAuth) {
     ...
     * 得到服务器返回的包含access token等的回应包后，解析存储到OAuth类中
     * 
     * @param responseData 格式：access_token=ACCESS_TOKEN&expires_in=60&openid=
     *            OPENID &openkey= OPENKEY
     * @param oAuth
     * @return
     */
