...
public class TAPI extends BasicAPI {
    ...
    private String tAddMusicUrl = apiBaseUrl + "/t/add_music";
    private String tGetVideoInfoUrl = apiBaseUrl + "/t/getvideoinfo";
    private String tAddEmotionUrl = apiBaseUrl + "/t/add_emotion";
     ...
     */
    public String add(OAuth oAuth, String format, String content,
            String clientip, String longitude, String latitude, String syncflag) throws Exception {
        QArrayList paramsList = new QArrayList();
        paramsList.add(new BasicNameValuePair("format", format));
     ...
     */
    public String reAdd(OAuth oAuth, String format, String content,
            String clientip, String longitude, String latitude, String reid, String syncflag)
            throws Exception {
        QArrayList paramsList = new QArrayList();
        paramsList.add(new BasicNameValuePair("format", format));
        paramsList.add(new BasicNameValuePair("content", content));
        ...
        if (!TextUtils.isEmpty(syncflag)
                && oAuth.getOauthVersion().equals(OAuthConstants.OAUTH_VERSION_1))
            paramsList.add(new BasicNameValuePair("syncflag", syncflag));
     ...
     */
    public String addPic(OAuth oAuth, String format, String content,
            String clientip, String longitude, String latitude, String picpath, String syncflag)
            throws Exception {
        QArrayList paramsList = new QArrayList();
        paramsList.add(new BasicNameValuePair("format", format));
        paramsList.add(new BasicNameValuePair("content", content));
     ...
     * @throws Exception
     */
    public String addMusic(OAuth oAuth, String format, String content,
            String clientip, String longitude, String latitude, String music_url,
            String music_title, String music_author,
        ...
        paramsList.add(new BasicNameValuePair("longitude", longitude));
        paramsList.add(new BasicNameValuePair("latitude", latitude));
        paramsList.add(new BasicNameValuePair("music_url", music_url));
        paramsList.add(new BasicNameValuePair("music_title", music_title));
        paramsList.add(new BasicNameValuePair("music_author", music_author));
        if (!TextUtils.isEmpty(syncflag)
                && oAuth.getOauthVersion().equals(OAuthConstants.OAUTH_VERSION_1))
            paramsList.add(new BasicNameValuePair("syncflag", syncflag));

        return requestAPI.postContent(tAddMusicUrl, paramsList,
                oAuth);
    };
    ...
    public String addVideo(
            ...
            String clientip, String longitude, String latitude, String url,
            String syncflag) throws Exception {
        QArrayList paramsList = new QArrayList();
        paramsList.add(new BasicNameValuePair("format", format));
        paramsList.add(new BasicNameValuePair("content", content));
     ...
     * @param oAuth
     * @param format 返回数据的格式（json或xml）
     * @param video_url 视频地址，后台自动分析视频信息，支持youku，tudou，ku6（URL最长不能超过1024字节）
     * @return
     * @throws Exception
     */
    public String getVideoInfo(OAuth oAuth, String format, String video_url) throws Exception {
        QArrayList paramsList = new QArrayList();
        paramsList.add(new BasicNameValuePair("format", format));
        paramsList.add(new BasicNameValuePair("video_url", video_url));

        return requestAPI.postContent(tGetVideoInfoUrl, paramsList,
                oAuth);
    }
     ...
     * @throws Exception
     */
    public String addEmotion(OAuth oAuth, String format, String content, String clientip,
            String longitude, String latitude, String syncflag, String signtype) throws Exception {
        QArrayList paramsList = new QArrayList();
        paramsList.add(new BasicNameValuePair("format", format));
        paramsList.add(new BasicNameValuePair("content", content));
        paramsList.add(new BasicNameValuePair("clientip", clientip));
        ...
        paramsList.add(new BasicNameValuePair("latitude", latitude));
        paramsList.add(new BasicNameValuePair("syncflag", syncflag));
        paramsList.add(new BasicNameValuePair("signtype", signtype));

        return requestAPI.postContent(tAddEmotionUrl, paramsList,
                oAuth);
    }
    ...
    public void setAPIBaseUrl(String apiBaseUrl) {
        ...
        tAddMusicUrl = apiBaseUrl + "/t/add_music";
        tGetVideoInfoUrl = apiBaseUrl + "/t/getvideoinfo";
        tAddEmotionUrl = apiBaseUrl + "/t/add_emotion";
    }
}
