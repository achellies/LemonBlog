...
public class OAuth implements Serializable {
    ...
    protected String oauthVersion = OAuthConstants.OAUTH_VERSION_1;// OAuth鉴权的版本
                                                                   // 1.0 或 2.a
    ...
    /**
     * 应用所使用的SDK版本，请从
     * {@link com.tencent.weibo.constants.OAuthConstants#APP_FROM_ANDROID_SDK_1}
     * 与 {@link com.tencent.weibo.constants.OAuthConstants#APP_FROM_JAVA_SDK_2}
     * 中选择
     */
    ...
    /**
     * 认证状态:<br>
     * <li>0:成功, <li>1:Request失败, <li>2:获取验证码失败, <li>3:Access失败
     */
