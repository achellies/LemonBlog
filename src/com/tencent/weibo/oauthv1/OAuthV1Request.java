...
public class OAuthV1Request implements RequestAPI {
    ...
    public String getResource(String url, List<NameValuePair> paramsList, OAuth oAuth)
        ...
        String queryString = OAuthV1Client.getOauthParams(url, "GET",
                oAuthV1.getOauthConsumerSecret(),
    ...
    public String postContent(String url, List<NameValuePair> paramsList, OAuth oAuth)
        ...
        String queryString = OAuthV1Client.getOauthParams(url, "POST",
                oAuthV1.getOauthConsumerSecret(),
                oAuthV1.getOauthTokenSecret(), paramsList);
    ...
    public String postFile(String url, List<NameValuePair> paramsList, List<NameValuePair> files,
