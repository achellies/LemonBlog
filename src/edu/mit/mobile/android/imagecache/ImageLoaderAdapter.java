...
public class ImageLoaderAdapter extends AdapterWrapper implements ImageCache.OnImageLoadListener {
     ...
     * @param wrapped
     * @param cache
     * @param imageViewIDs a list of resource IDs matching the ImageViews that
     *            should be scanned and loaded.
     * @param defaultWidth the default maximum width, in the specified unit.
     *            This size will be used if the size cannot be obtained from the
     *            view.
     * @param defaultHeight the default maximum height, in the specified unit.
     *            This size will be used if the size cannot be obtained from the
     *            view.
    ...
    @Override
    public void onImageLoaded(long id, final Uri imageUri, final Drawable image) {
